...
export const APP_ID = "choreboard";
...
export class ChoreStore {
  ...
  constructor(publicDoc: Y.Doc, adminDoc: Y.Doc | null) {
    ...
    this.family = publicDoc.getMap("family");
    this.members = publicDoc.getMap("members");
    this.catalog = publicDoc.getMap("catalog");
    this.completions = publicDoc.getMap("completions");
    this.proposals = publicDoc.getMap("proposals");
    this.permDefaults = publicDoc.getMap("permDefaults");
    this.permOverrides = publicDoc.getMap("permOverrides");

    if (adminDoc) {
      this.adminFamily = adminDoc.getMap("family");
      this.chores = adminDoc.getMap("chores");
      this.payments = adminDoc.getMap("payments");
      this.adminPermDefaults = adminDoc.getMap("permDefaults");
      this.adminPermOverrides = adminDoc.getMap("permOverrides");
    } else {
